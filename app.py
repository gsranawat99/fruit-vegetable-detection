...
def predictRoute():
    try:
        ...
        os.system("cd yolov9/ && python detect.py --weights gelan-c.pt --img 416 --conf 0.5 --source ../data/inputImage.jpg")
...
def predictLive():
    try:
        ...
        os.system("cd yolov9/ && python detect.py --weights gelan-c.pt --img 416 --conf 0.5 --source 0")
